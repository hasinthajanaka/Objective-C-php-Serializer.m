...
-(NSString *)serialize:(id)object inString:(NSString *)str{
    ...
    if([object isKindOfClass:[NSArray class]]){
        ...
        str= [str stringByAppendingFormat:@"a:%d:{",[a count]];
       ...
       str=[str stringByAppendingString:@"{"];
        ...
        str= [str stringByAppendingFormat:@"a:%d:{",[[a allKeys]count]];
        ...
        return [str stringByAppendingFormat:@"s:%d:\"%@\";",[(NSString *)object length],(NSString *)object];
